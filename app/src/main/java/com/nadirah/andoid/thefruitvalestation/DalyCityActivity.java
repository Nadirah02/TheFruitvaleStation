package com.nadirah.andoid.thefruitvalestation;
...
public class DalyCityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstTrainTextView = findViewById(R.id.firstTrain);
        secondTrainTextView = findViewById(R.id.secondTrain);
        thirdTrainView = findViewById(R.id.thirdTrain);
    }
